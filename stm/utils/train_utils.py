...
class Logger(SummaryWriter):
    ...
    def log_val_stm_loss(self, loss, epochs):
        self.add_scalar('valid_stm_loss', loss.item(), epochs)

    def log_val_emo_loss(self, loss, epochs):
        self.add_scalar('val_emo_loss', loss.item(), epochs)
    ...
    def log_emo_lambda(self, _lambda, epochs):
        self.add_scalar('lambda', _lambda, epochs)
